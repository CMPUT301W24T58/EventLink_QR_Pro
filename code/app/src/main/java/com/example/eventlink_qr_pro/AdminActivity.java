...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button viewImagesAdminButton = findViewById(R.id.view_images_button);
...
//        viewImagesAdminButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                // Handle "Edit Profile" action here
//                Intent intent = new Intent(AdminActivity.this, EditProfileActivity.class); // TODO: change from editprofileactivity to viewprofileactivity
//                //intent.putExtra("attendee", attendee);
//                //startActivityForResult(intent, EDIT_PROFILE_REQUEST_CODE);
//                startActivity(intent);
//            }
